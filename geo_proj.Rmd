...
tunegrid <- expand.grid(.mtry=c(1:15), .ntree=c(50,100,150,300,450,600))
...
res_rf_kmeans<-sperrorest(modelformula, data=dane, 
                          ...
                          progres='all', 
                          smp_args=list(repetition=3, nfold=5, seed1=1234))
...
rmse= c(round(rmse_ord,2), round(rmse_un_xy,2), round(a$RMSE,2), round(b$RMSE,2), round(mean(res_rf_kmeans$error_rep$test_rmse),2))
